...
class JuradoController extends Controller
{
    ...
    public function index()
    {
        ...
        $item = User::select('as_jurado.id','as_tipojurado.nombre AS tipo_jurado', 'as_jurado.Nombre', 'Empresa','Email','nom_imagen','aceptacion','biografia')->join('as_tipojurado', 'as_jurado.id_tipojurado', '=', 'as_tipojurado.id')->where('as_jurado.id_edicion', $id_edicion[0]->id)->get();
